...
export default function ProductGallery({ images, title }: Props) {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Main image */}
      <div className="relative aspect-square w-full overflow-hidden rounded-lg border border-line bg-paper">
        {current ? (
          <img
            src={current.url}
          ...
          <div className="grid h-full place-items-center text-mist">No image</div>
        )}
        <span className="absolute bottom-3 right-3 rounded-sm bg-snow/85 px-2 py-1 font-mono text-[0.7rem] text-graphite backdrop-blur-sm tabular">
